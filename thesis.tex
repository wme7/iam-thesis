...
%----------- watermark -----------
\CenterWallPaper{0.35}{figures/watermark.pdf}
\setlength{\wpXoffset}{0.0cm}
\setlength{\wpYoffset}{0.0cm}
...
\includepdf[pages={1}]{certificate/cert.pdf}

\onehalfspacing \input{frontMatter/acknowledgementsCH}
\onehalfspacing \input{frontMatter/abstractCH}
\doublespacing \input{frontMatter/abstractEN}

\tableofcontents

\doublespacing \listoffigures
\doublespacing \listoftables
...
\bibliography{backMatter/thesisRefs}
